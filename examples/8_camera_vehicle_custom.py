...
class PegasusApp:
    ...
    def __init__(self):
        ...
        mavlink_config = PX4MavlinkBackendConfig({
            "vehicle_id": 0,
            "px4_autolaunch": True,
            "px4_dir": "/home/usrg/IsaacPX4/PX4-Autopilot"
        })
        ...
        asyncio.ensure_future(self.create_ros_action_graph(vehicle_stage_path))
    ...
    async def create_ros_action_graph(self, vehicle_stage_path):
        try:
