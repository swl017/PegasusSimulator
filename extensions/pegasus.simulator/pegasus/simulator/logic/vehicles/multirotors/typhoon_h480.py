...
class typhoon_h480Config(MultirotorConfig):
    ...
    def __init__(self):
        ...
        self.usd_file = ROBOTS["typhoon_h480"]
...
class typhoon_h480(Multirotor):

    def __init__(self, id: int, world, init_pos=[0.0, 0.0, 0.07], init_orientation=[0.0, 0.0, 0.0, 1.0], config=typhoon_h480Config()):
